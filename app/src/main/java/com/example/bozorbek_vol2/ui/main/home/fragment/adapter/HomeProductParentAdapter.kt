...
class HomeProductParentAdapter(val requestManager: RequestManager) : RecyclerView.Adapter<HomeProductParentAdapter.HomeProductParentViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeProductParentViewHolder {
        return HomeProductParentViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_home_parent_product, parent, false), requestManager)
    }
    ...
    inner class HomeProductParentViewHolder(itemView:View, val requestManager: RequestManager) : RecyclerView.ViewHolder(itemView)
    {
